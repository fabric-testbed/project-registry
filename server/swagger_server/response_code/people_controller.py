...
def people_get(person_name=None):  # noqa: E501
    ...
    """
    # response = {'ResponseType': 'PeopleShort'}
    fab_people = []
    if person_name:
    ...
    # response['FabricPeople'] = fab_people
    response = fab_people
...
def people_oidc_claim_sub_get(oidc_claim_sub):  # noqa: E501
    ...
    """
    # response = {'ResponseType': 'PeopleLong'}
    pl = PeopleLong()
...
def people_role_attribute_sync_get():  # noqa: E501
    ...
    :rtype: None
    """
    # TODO: extract person_id from request
    if sync_roles_per_person(3):
        return cors_response(
            request=request,
            status_code=200,
            body='OK'
